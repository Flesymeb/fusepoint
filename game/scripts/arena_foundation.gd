...
func _atmosphere_snapshot() -> Dictionary:
	...
	return {
		"daylight_exposure": {
			...
			"profile_id": &"loop44_filmic_highlight_headroom",
			...
			"highlight_isolation": &"filmic_white_headroom_without_material_or_sun_override",
			"coherent_profile_tuple": [0.8, 0.75, 0.7, Environment.TONE_MAPPER_FILMIC, 1.0, 6.0, 1.35],
			"global_exposure_changed": false,
