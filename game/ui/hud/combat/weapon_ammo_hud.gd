...
func _mcp_state() -> Dictionary:
	return {
		...
		"silhouette_family": {
			"family_id": &"equipped_weapon_silhouettes",
			"prd_style": &"grounded_tactical_ivory_cutouts",
			"source_quality": &"production_weapon_matched_transparent_vector",
			"expected_runtime_uses": 2,
			"distinct_source_variants": 2,
			"runtime_variants": 2,
			"maximum_single_variant_share": 0.5,
			"diversity_axis": &"ak74m_assault_rifle_vs_saiga12_breach_shotgun_profile",
