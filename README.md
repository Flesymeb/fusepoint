...
| Field | Value |
| --- | --- |
| Active product issues | 14 |
| QA / evidence debt | 15 |
| Open | 20 |
| Fixed pending verify | 2 |
| Blocked | 0 |
| Regressed | 7 |
| Closed | 44 |

Active unresolved issue ids (open, fixed pending verify, and regressed):
...
- `finding.combat-feedback-matrix-incomplete`
- `finding.integrated-slice-unqualified`
- `finding.runtime-scenario-not-retained`
- `finding.spawn-alpha-route-budget`
- `fp.combat.enemy-rifle-pistol-animation-binding`
- `fp.combat.settings-200-scale-clipping`
- `fp.combat.enemy-root-tilt`
- `coverage.baseline.fps_event_hud_presentation.4d419ec755bb`
- `coverage.baseline.fps_reticle_ballistics.1866fc5e17a5`
- `fp.combat.viewmodel-hands-runtime-missing`
- `fp.combat.environment-highlight-clipping`
- `finding.footstep-long-stream-restart`
- `finding.weapon-audio-mixed-output-unavailable.loop44`
- `fps.weapon.report-audio-long-source`
- `finding.feedback-duplicate-cleanup.loop45`
- `fp.combat.gameplay-story-cue-unreadable`
...
| --- | --- | --- |
| `loop-61-4d5e2eecfcde` | `development_snapshot:attempt-f25eb311e1dd391d65768021` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-61-4d5e2eecfcde`
- Accepted candidate: `none`
- Latest attempted: `loop-61-4d5e2eecfcde`
- Latest warm start: `loop-61-6cbc65e09b17`
- Last published: `loop-61-4d5e2eecfcde`
- Best verified: `loop-60-6cbc65e09b17`
