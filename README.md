...
- `finding.gameplay-route-opaque-card`
- `fp.combat.settings-200-scale-clipping`
- `fp.combat.enemy-root-tilt`
- `fp.combat.settings-debug-instructions`
...
| --- | --- | --- |
| `loop-29-ec60b7ef7f9d` | `development_snapshot:attempt-aac0d9ac735ee25b78c299e0` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-29-ec60b7ef7f9d`
- Accepted candidate: `none`
- Latest attempted: `loop-29-ec60b7ef7f9d`
- Latest warm start: `loop-29-ef61d05d3249`
- Last published: `loop-29-ec60b7ef7f9d`
- Best verified: `loop-28-ef61d05d3249`
