...
- `fp.combat.damage-feedback-missing`
- `fp.combat.enemy-restart-state-drift`
...
| --- | --- | --- |
| `loop-11-5a14b1d8d8e1` | `development_snapshot:attempt-dcf7837c663869c7d029a382` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-11-5a14b1d8d8e1`
- Accepted candidate: `none`
- Latest attempted: `loop-11-5a14b1d8d8e1`
- Latest warm start: `loop-11-d1ae1f6d5741`
- Last published: `loop-11-5a14b1d8d8e1`
- Best verified: `loop-10-d1ae1f6d5741`
