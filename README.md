...
- `fp.combat.calibration-target-shipped`
- `fp.combat.enemy-shot-presentation-missing`
- `fp.combat.viewmodel-ads-motion-no-response`
...
| --- | --- | --- |
| `loop-12-6ce76152114d` | `development_snapshot:attempt-699887fcddbb1ceb0a4ccb29` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-12-6ce76152114d`
- Accepted candidate: `none`
- Latest attempted: `loop-12-6ce76152114d`
- Latest warm start: `loop-12-5a14b1d8d8e1`
- Last published: `loop-12-6ce76152114d`
- Best verified: `loop-11-5a14b1d8d8e1`
