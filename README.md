...
| --- | --- | --- |
| `loop-42-d97eb4a8bddb` | `development_snapshot:attempt-0e032ab8f478cd6d02d2bd00` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-42-d97eb4a8bddb`
- Accepted candidate: `none`
- Latest attempted: `loop-42-d97eb4a8bddb`
- Latest warm start: `loop-42-d3cd1fee36ab`
- Last published: `loop-42-d97eb4a8bddb`
- Best verified: `loop-41-d3cd1fee36ab`
