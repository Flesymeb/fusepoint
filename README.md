...
- `fp.combat.enemy-spawn-overlap`
- `fp.combat.ui-scale-hud-clipping`
...
- `fp.viewmodel.component-internal-patch`
- `fp.combat.enemy-rifle-pistol-animation-binding`
- `fp.combat.enemy-spawn-inside-authored-geometry`
...
| --- | --- | --- |
| `loop-33-6a563dd24fc9` | `development_snapshot:attempt-90fb72c52298fb083eeb288b` | DEVELOPER REPORT READY |
...
- Latest candidate: `loop-33-6a563dd24fc9`
- Accepted candidate: `none`
- Latest attempted: `loop-33-6a563dd24fc9`
- Latest warm start: `loop-33-2943fdf3be7e`
- Last published: `loop-33-6a563dd24fc9`
- Best verified: `loop-32-2943fdf3be7e`
